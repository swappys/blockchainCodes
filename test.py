...
# Testing the base python app
print("Welcome to Blockchain using python")

# testing the .env file
infuraUrl = config('INFURA_URL')
print('Infura url: ' + infuraUrl)

# This is the address of your ERC20 Contract (0xblablah)
contractAddress = config('CONTRACT_ADDRESS')

# This is your primary metamask address (0xblablah)
...
# This is like API but for blockchain
...
if res:
    ...
    print("My Contract Symbol is: "+symbol)

    decimals = contract_instance.functions.decimals().call()
    print("My Contract Decimals is: "+ str(decimals))

    balance = contract_instance.functions.balanceOf(ownerAddress).call()
    print("My Contract Balance is: "+ str(balance))
